...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['django.core.management.commands.runserver', 'django.core.management.commands.migrate', 'django.contrib.staticfiles.management.commands.runserver'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
